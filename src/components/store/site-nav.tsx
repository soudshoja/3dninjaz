...
export function SiteNav({ categoryTree }: { categoryTree: CategoryTreeNode[] }) {
  ...
  return (
    ...
    <nav
      ref={navRef}
      aria-label="Primary"
      className="sticky top-0 z-40 border-b border-zinc-200 bg-white overflow-x-clip"
    >
            ...
            <div className="flex items-center gap-3">
              {BUSINESS.socials.instagram && (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Instagram"
                  className="inline-flex items-center justify-center rounded-full min-h-[44px] min-w-[44px] transition-transform hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
                  style={{ "--tw-ring-color": BRAND.blue } as React.CSSProperties}
                >
