...
function variantClasses(variant: WhatsAppCtaVariant): string {
  switch (variant) {
    ...
    case "inline":
      return [
        "inline text-[#2563EB] underline underline-offset-2",
        "hover:opacity-80",
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2563EB] focus-visible:ring-offset-2 focus-visible:ring-offset-[#F7FAF4] rounded-sm",
      ].join(" ");
  }
}
