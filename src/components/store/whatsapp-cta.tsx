...
function variantClasses(variant: WhatsAppCtaVariant): string {
  switch (variant) {
    ...
    case "inline":
      return [
        "inline text-[#123456] underline underline-offset-2",
        "hover:opacity-80",
        "focus:outline-none focus-visible:ring-2 focus-visible:ring-[#123456] focus-visible:ring-offset-2 focus-visible:ring-offset-[#F7FAF4] rounded-sm",
      ].join(" ");
  }
}
