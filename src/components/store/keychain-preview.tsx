 ...
 *                 (#FFFFFF, D-04) — icons never use customer colours. All-letter
 *                 sequences stay pixel-identical to the legacy text path (this
 *                 branch is untouched).
 */
...
/** Fixed white keycap shell for icon slots — icons never use customer colours (D-04, restored). */
...
type Props = {
   ...
   * shell (D-04) — icons never use customer colours.
   */
  slots?: KeycapSlot[];
};
          ...
          return (
            <div
              ...
              style={{
                ...
                // Icon slots sit on a FIXED WHITE shell (D-04, restored) — icons
                // never use customer colours. Letter slots keep the customer's
                // chosen Base colour. All-letter → always baseHex → byte-identical.
