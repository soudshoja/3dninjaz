...
/**
 * /account/security ChangePasswordForm. Better Auth handles the
 * currentPassword challenge server-side; we additionally enforce a
 * confirmNewPassword UI check before submitting (Zod schema only validates
 * newPassword + diff-from-current per spec).
 */
  ...
  return (
    <form onSubmit={onSubmit} className="grid gap-4" noValidate>
      ...
      <div>
        ...
        />
        <p id="new-password-hint" className="text-xs text-slate-600 mt-1">
