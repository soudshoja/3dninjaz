...
/**
 * Cancel request form — collapsible. Visible only when the parent panel
 * decides the order qualifies (status ∈ pending|paid AND no pending request).
 * Server-side eligibility re-validated in submitOrderRequest.
 */
      ...
      {!open ? (
        ...
        <form onSubmit={onSubmit} className="grid gap-3">
          ...
          <textarea
            ...
            placeholder="A short reason helps our team approve faster (10-1000 chars)."
          />
