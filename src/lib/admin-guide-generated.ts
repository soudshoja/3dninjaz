...
**Tip:** Start with broad category names. You can always add subcategories later. Three to five top-level categories is usually enough for a small store — more than that and the filter starts to feel overwhelming.`,
  ...
  {
    slug: "products/made-to-order",
    title: "Made-to-Order Products",
    category: "Products",
    tags: ["configurable","made-to-order","configurator","tier-pricing","keychain"],
    order: 9,
    href: "/admin/guide/products/made-to-order",
    content: `# Made-to-Order Products
...
- [Options, values, and variants](/admin/guide/products/variants-sizes) — for comparison with the stocked product path`,
  ...
  {
    slug: "products/meshy-3d-generation",
    title: "AI 3D Model Generation (Meshy)",
    category: "Products",
    tags: ["meshy","3d","ai","generation","printability","bambu","keychain"],
    order: 10,
    href: "/admin/guide/products/meshy-3d-generation",
    content: `# AI 3D Model Generation (Meshy)
