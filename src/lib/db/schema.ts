  ...
  return [
    ...
    },
    {
      ...
      html: brandedEmailTemplate(
        ...
        <p>If you have questions, contact us at <a href="mailto:{{support_email}}" style="color:#123456">{{support_email}}</a></p>`,
        { text: "View Order", url: "order_link" }
      ),
      variables: [
        "customer_name",
    ...
    },
    {
      ...
      html: brandedEmailTemplate(
        ...
        <p style="margin-top:16px">If this was unexpected, please contact us at <a href="mailto:{{support_email}}" style="color:#123456">{{support_email}}</a></p>`,
    ...
    },
    {
      ...
      html: brandedEmailTemplate(
        ...
        <p style="margin-top:16px">If you didn't make this change, please contact us immediately at <a href="mailto:{{support_email}}" style="color:#123456">{{support_email}}</a></p>`,
        undefined
      ),
      variables: [
        "customer_name",
    ...
    },
    {
      ...
      html: brandedEmailTemplate(
        ...
        <p style="margin-top:16px">We're investigating and will keep you updated. Contact us at <a href="mailto:{{support_email}}" style="color:#123456">{{support_email}}</a> if you have additional details.</p>`,
        { text: "View Order", url: "order_link" }
      ),
      variables: [
        "customer_name",
