/**
 * Country codes list with ITU dial codes.
 * dial is WITHOUT "+", e.g. "60", "1", "44", "971".
 * Sorted by country name. Malaysia is the default.
 */
...
export const DEFAULT_DIAL = "60"; // Malaysia
...
export const COUNTRY_CODES: CountryCode[] = [
  ...
  { iso2: "TL", name: "East Timor", dial: "670" },
  ...
  { iso2: "GG", name: "Guernsey", dial: "441481" },
  ...
  { iso2: "IM", name: "Isle of Man", dial: "441624" },
  ...
  { iso2: "JE", name: "Jersey", dial: "441534" },
  ...
  { iso2: "VI", name: "US Virgin Islands", dial: "1340" },
 ...
 * Returns the first match (some dial codes map to multiple countries, e.g. "1").
 * Malaysia (+60) is always preferred if dial === "60".
 */
export function findCountryByDial(dial: string): CountryCode | undefined {
  // Prefer exact iso2 match for MY when dial is "60"
