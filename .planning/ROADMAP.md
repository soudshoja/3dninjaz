...
### Phase 21: Admin Meshy AI 3D Generation Tool — admin uploads a reference photo, generates a textured 3D model via Meshy's Image-to-3D API, previews the result thumbnail, and downloads STL/3MF for Bambu Studio slicing/printing
